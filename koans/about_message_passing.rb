...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # THINK ABOUT IT:
    #
    # Why does Ruby provide both send and __send__ ? A: So a different method send can be implemented while still preserving __send__.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # A: We can redefine it to handle the error differently.
    #
    # NOTE:
    #
    ...
    #
    # Thanks. We now return you to your regularly scheduled Ruby Koans.
  end
